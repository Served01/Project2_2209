<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="BKRV.book.bookDAO" %> 
<%@ page import="BKRV.book.bookBean" %> 
...
<body>
<%
	String location	= "D:\\jspworkspace\\bookReviewProgram\\src\\main\\webapp\\upload";//사진이 저장될 경로
	String filename = "";
...
%>
	<jsp:useBean id="bBean" class="BKRV.book.bookBean" scope="page">
	</jsp:useBean>	
<%
