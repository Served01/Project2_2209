...
%>
	...
	<form action="mbPassPro.jsp" method="post">
		<div align="center">
			<table border="1" style="text-align: center; width: 50%;" class = "update">
				...
				<tr style="height: 40;">
					<td colspan="2">
						<input type="hidden" name="mb_id" value="<%=mBean.getMb_id()%>">
						 ...
						 <input type="button" class = "button" value="회원정보조회" onclick="location.href='mbList.jsp?'" />
						 <button class = "button" onclick="location.href='mainSession.jsp?center=mbUpdateform.jsp&mb_id=<%=mBean.getMb_id()%>'">회원정보 수정화면</button>
				   </td>
				</tr>
			</table>
		</div>
