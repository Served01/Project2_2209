...
insert into book_info values(20220002, 'JAVA교육', '김남영', '파랑출판사', '2010-08-20', 'bbb', 0, 5, 1, sysdate, '교육용 책2');
insert into book_info values(20220003, 'CSS교육', '김경빈', '빨강출판사', '2010-09-03', 'ccc', 0, 4, 0, sysdate, '교육용 책3');